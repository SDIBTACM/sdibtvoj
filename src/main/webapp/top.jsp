...
<div id='cssmenu'>
    <ul>
        ...
        <li style="float:right"><s:if test="#session.visitor != null"><a id="logout"
                                                                         href="javascript:void(0)">LOGOUT</a></s:if><s:else><a
                class="login" href="javascript:void(0)">LOGIN</a></s:else></li>
        <li style="float:right"><s:if test="#session.visitor != null"><a id="my_account"
                                                                         uid="<s:property value='#session.visitor.id' />"
                                                                         href="${contextPath}/user/toUpdate.action?uid=<s:property value="#session.visitor.id" />"><s:property
                value="#session.visitor.username"/></a></s:if><s:else><a class="register" href="javascript:void(0)">REGISTER</a></s:else>
        </li>
    </ul>
</div>
    ...
    <div id="dialog-form-login" style="display: none" title="Login">
        ...
        <form id="login_form" action="javascript:void(0)">
            <fieldset>
                ...
                <img id="image" border="0" onclick="refresh()" src="verifyCodeImg" alt="验证码">
            </fieldset>
        </form>
    </div>
    ...
    <div id="dialog-form-register" style="display: none" title="Register">
        ...
        <fieldset>
            <div style="width:200px;float:left">
                ...
                <label for="share">Share code by default</label>
                <br/><s:radio id="share" name="share" list="#{'0':'No', '1':'Yes'}" value="1" theme="simple"/></div>
            <div style="width:200px;margin-left:20px;float:left"><label for="blog">Blog &
                Introduction</label><s:textarea id="blog" rows="25" cols="35"
                                                cssClass="text ui-widget-content ui-corner-all"/></div>
        </fieldset>
    </div>
</s:if>
<script type="text/javascript">
    function refresh() {
        ...
        document.getElementById("image").src = "verifyCodeImg?" + new Date();
    }
</script>